...
Enterexitanimation::Enterexitanimation(QWidget *parent) : QWidget(parent)
{
    ...
    closeBt->setStyleSheet("QPushButton{border-image:url(:/icon/Resource/icons/menu);outline:none}"
                           "QPushButton:pressed{border-image:url(:/icon/Resource/icons/menu_clicked);}");
